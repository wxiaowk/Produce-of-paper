...
def parser():
   #This creates the parser
    ...
    parser.add_argument('--model', choices=["Base_CNN", "simpleCNN", "CNN", 'DeepJSCC', 'DeepJSCC1'], default="Base_CNN", #This adds an argument to the parser
    ...
    # parser.add_argument('--channel', default='awgn', help='the channel for communication')

    ## Training realted
    parser.add_argument('--snr_list', default=['16', '13', '10',
